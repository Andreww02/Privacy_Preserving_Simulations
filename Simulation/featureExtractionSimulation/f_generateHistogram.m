function [angles, sumDerivativesLogNorm, angleEdges, featureEdges, counts] = ...
...
%     angles, sumDerivativesLogNorm, angleEdges, featureEdges, counts
    ...
    sumDerivativesLogNorm = (sumDerivativesLog - min(sumDerivativesLog)) / ...
                            (max(sumDerivativesLog) - min(sumDerivativesLog));
    ...
    % % Plot the heatmap in the provided axes.
    ...
    gammaVal = 0.5;  % Example gamma value.
...
% function [angles, sumDerivativesLogNorm, angleEdges, featureEdges, counts] = f_generateHistogram(img, numLines, lineLength, numBinsFeature, numBinsAngle)
